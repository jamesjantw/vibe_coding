...
这是 BMad Method V6 Alpha 的完整开发流程，适用于 BMad Method 和 Enterprise 轨迹：
...
# ============================================
# 阶段 2: 既有项目文件化（仅既有项目需要）
# ============================================

# 2. 如果是既有项目（Brownfield），先建立项目文件
...
# 9. 为 Story x.1 生成技术上下文 XML
/bmad:bmm:workflows:story-context 为 Story x.1 生成技术上下文 XML

# 10. 开始实作 Story x.1
/bmad:bmm:workflows:dev-story 开始实作 Story x.1
...
# - 随时使用 *workflow-status 查看进度
# - Epic 和 Story 循环会根据实际情况重复执行
```
